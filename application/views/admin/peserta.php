...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
                        ...
                        <table id="TabelPeserta" class="table table-striped table-bordered dataTable" style="width:100%" role="grid" aria-describedby="example_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 10%;" aria-label="Salary: activate to sort column ascending">Tgl Verifikasi</th>
